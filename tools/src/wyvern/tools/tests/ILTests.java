...
public class ILTests {
    ...
    public void testBind() throws BreakException {
        ...
        Expression bindExpr = new Bind(
                new ArrayList<VarBinding>(Arrays.asList(new VarBinding("x", integer, five))),
                new Variable("x"));
    ...
    public void testMultiVarBind() throws BreakException {
        ...
        Expression bindExpr = new Bind(new ArrayList<VarBinding>(Arrays.asList(
                ...
                new VarBinding("y", integer, new IntegerLiteral(2)),
                new VarBinding("z", integer, new IntegerLiteral(3)))),
                new Variable("y"));
    ...
    public void testSingleModule() throws ParseException {
        ...
        GenContext genCtx = Globals.getStandardGenContext().extend("D", new Variable("D"), Util.unitType());
        //new EmptyGenContext(new InterpreterState(null, null)).extend("system", new Variable("system"),
        // new NominalType("", "system")).extend("D",  new Variable("D"), Util.unitType());
